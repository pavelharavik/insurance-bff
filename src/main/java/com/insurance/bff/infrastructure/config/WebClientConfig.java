...
/**
 * Configures a {@link WebClient} for each upstream system with dedicated base URLs and timeouts
 * sourced from {@link UpstreamProperties}.
 */
@Configuration
...
public class WebClientConfig {
  ...
  private WebClient buildWebClient(WebClient.Builder builder,
      UpstreamProperties.SystemProperties props) {
