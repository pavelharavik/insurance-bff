...
public class WebClientConfig {
    ...
    /**
     * Spring Boot auto-configures {@link WebClient.Builder} as a prototype bean pre-loaded
     * with all codec customisers (including {@code Jackson2XmlDecoder} when
     * {@code jackson-dataformat-xml} is on the classpath). Injecting it here instead of
     * calling {@link WebClient#builder()} statically ensures those codecs are present.
     */
    @Bean
